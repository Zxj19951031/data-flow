package org.example.plugins.common.records;

import com.alibaba.fastjson.JSON;
import org.example.plugins.common.columns.Column;
import org.example.plugins.common.commons.ClassSize;
...
public class DataRecord implements Record {
    ...
    public void setColumn(int i, Column column) {
        if (i < 0) {
            throw SystemException.newException(ColumnError.ARGUMENT_ERROR, "不能给index小于0的column设置值");
        }
