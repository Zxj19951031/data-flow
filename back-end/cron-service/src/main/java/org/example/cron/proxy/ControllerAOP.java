package org.example.cron.proxy;
...
public class ControllerAOP {
    ...
    @Pointcut("execution(public org.example.cron.commons.SystemResponse org.example.cron.controller..*.*(..))")
    ...
    public SystemResponse<?> parameterMissingExceptionHandler(MissingServletRequestParameterException e) {
        logger.error("缺失参数", e);
        return SystemResponse.error(SystemException.newException(SystemError.PARAMETER_ERROR, "缺失参数"));
    }
