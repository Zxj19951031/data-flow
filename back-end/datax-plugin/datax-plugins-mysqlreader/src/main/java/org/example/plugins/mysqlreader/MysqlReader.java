package org.example.plugins.mysqlreader;


import cn.hutool.core.lang.Assert;
import org.example.plugins.common.Reader;
import org.example.plugins.common.columns.*;
    ...
    public static class Job extends Reader.Job {
        ...
        public void init() {
            ...
            try {
                ...
                log.error("插件初始化异常!!!", e);
                throw SystemException.newException(CommonError.PLUGIN_INIT_ERROR,
    ...
    public static class Task extends Reader.Task {
        ...
        public void startRead(RecordProducer producer) {
            ...
            try {
                    ...
                    for (int i = 1; i <= metaData.getColumnCount(); i++) {
                        switch (metaData.getColumnType(i)) {
                            ...
                            case Types.NULL:
                                ...
                                break;
                            default:
                                throw SystemException.newException(PluginError.TASK_UNSUPPORTED_TYPE,
                ...
                throw SystemException.newException(PluginError.TASK_READ_ERROR, e);
            } finally {
                try {
                    if (null != resultSet) {
                        resultSet.close();
