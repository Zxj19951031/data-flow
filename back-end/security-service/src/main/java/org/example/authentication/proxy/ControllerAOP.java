package org.example.authentication.proxy;
...
public class ControllerAOP {
    ...
    @Pointcut("execution(public org.example.authentication.commons.SystemResponse org.example.authentication.controller..*.*(..))")
